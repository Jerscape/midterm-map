...
const handleCreateMap = async function(){
  ...
  map = new Map(document.getElementById("locs-container"), { //probably why the favourite container isn't displaying local, it's fetching another id name
    center: { lat: 53.54702366643828, lng: -113.4930045077159 },
    zoom: 10,
  });
...
//Checks if a user cookie was set from the server
...
$(() => {
  ...
  let isAuthenticated = getIsAuthenticated().then((data) => {
